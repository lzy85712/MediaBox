 ...
 */
public class LvMineSellAdapter extends BaseAdapter {
    private ArrayList<String> mDatas;
    private Context mContext;

    private LayoutInflater mInflater;

    public LvMineSellAdapter(ArrayList<String> datas, Context context) {
        this.mDatas = datas;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.item_lv_mine_sell, parent, false);
