 ...
 */
public class GvReportAdapter extends BaseAdapter {
    private ArrayList<String> al_datas;
    private Context context;
    private LayoutInflater mInflater;

    public GvReportAdapter(ArrayList<String> al_datas, Context context) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.item_gv_report, null);
